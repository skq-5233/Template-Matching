...
namespace Template_Mask
{
    public partial class Form1 : Form
    {
        ...
        private void Delete_Area_Click(object sender, EventArgs e)
        {
            ...
            listBox1.Items.RemoveAt(deleteindexRectangle);//删除选中区域；
